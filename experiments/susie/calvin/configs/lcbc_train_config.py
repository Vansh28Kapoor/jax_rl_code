        ...
        "lc_ddpm_bc": ConfigDict(
            dict(
                ...
                agent_kwargs=dict(
                    ...
                    mmdit_type="incontext", # "mmdit"/ "incontext"
                    ...
                    embed_lang_in_observation=True,
                    language_conditioned=True,
                    imagination_augmented=False,
                    use_attention_in_imagination=False,
                    attention_type_in_imagination="single_head",
                    num_similar_instructions_used=4,
                    use_null_similar_images=False,
